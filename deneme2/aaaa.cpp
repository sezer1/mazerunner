...
int sayi=0;
    sf::Color color0 = sf::Color::White;
sf::Color color1 = sf::Color::Black;
sf::Color color2 = sf::Color::Yellow;
sf::Color color3 = sf::Color::Magenta;
sf::Color color4 = sf::Color::Cyan;
sf::Color color5 = sf::Color::Transparent;
...
/*
 text1.setString("1"); // Yazı değeri ayarlanıyor
    text1.setCharacterSize(24); // Yazı boyutu ayarlanıyor
    text1.setFillColor(sf::Color::Blue);

  text2.setString("2"); // Yazı değeri ayarlanıyor
                    text2.setCharacterSize(24); // Yazı boyutu ayarlanıyor
                    text2.setFillColor(sf::Color::Blue);

                           text3.setString("3"); // Yazı değeri ayarlanıyor
                    text3.setCharacterSize(24); // Yazı boyutu ayarlanıyor
...
for (int i = 0; i < cellColors.size(); i++) {
    for (int j = 0; j < cellColors[i].size(); j++) {
        std::cout << cellColors[i][j].b<< " "<<endl;
    }
    std::cout << std::endl;
}
sayi--;
